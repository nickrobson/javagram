...
public class MethodLeaveChat extends Method<Boolean> {

    private Object chatId;

    public MethodLeaveChat() {
        super("leaveChat");
    }

    public MethodLeaveChat setChat(Chat chat) {
        this.chatId = this.getChatId(chat);
        return this;
    }

    public MethodLeaveChat setChatId(long chatId) {
        this.chatId = chatId;
        return this;
    }

    public MethodLeaveChat setChatId(String chatId) {
        this.chatId = chatId;
        return this;
    }
